...
local rofi = "rofi -show combi -combi-modes drun,run -show-icons -modes combi,window,filebrowser"
local menu = "hyprlauncher"
local nm = "iwmenu --launcher custom --launcher-command wofi --dmenu -i xdg"
...
hl.on("hyprland.start", function ()
   ...
   hl.exec_cmd("/opt/bearing/quality.sh")
   hl.exec_cmd(" sudo systemctl start sunshine")
end)
...
hl.bind(seconMod .. " + M", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(fileManager))
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd(menu))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd(rofi))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("/opt/bearing/quality.sh"))
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("/opt/MVS/bin/MVS.sh"))
